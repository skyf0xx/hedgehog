...
//
// The baseline in fixtures/shipped-cores-baseline.json was generated by
// running this same compile against the pre-cardinality tree (git HEAD
// before the feature branch). Regenerate it with:
//   node --experimental-sqlite repro/05-shipped-cores-unchanged.mjs --write-baseline
// but only from a checkout that predates the change — otherwise it stops
// proving anything.
